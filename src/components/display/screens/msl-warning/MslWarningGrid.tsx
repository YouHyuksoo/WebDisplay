        ...
        {rows.map((row, idx) => {
          ...
          return (
            ...
            >
              ...
              {/* Location */}
              <div className="flex-1 px-3 py-2 text-center text-xl font-bold text-zinc-300">
                {row.LOCATION_CODE ?? '-'}
              </div>
              {/* MSL Level */}
              ...
              {/* Remain Time */}
              <div className={`flex-1 px-3 py-2 text-right tabular-nums text-xl font-bold ${usedRate >= 90 ? 'text-red-400' : 'text-zinc-300'}`}>
