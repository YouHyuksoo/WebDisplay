/**
 * @file src/components/u1/fw/FwMachineNg.tsx
 * @description FW 머신별 NG 분포 — 수평 바 + 값 레이블 + NG율 + 요약
 *
 * 초보자 가이드:
...
import type { FwMachineNgItem } from "@/types/u1/fw-analysis";

interface Props {
  machineNg: FwMachineNgItem[];
}

export default function FwMachineNg({ machineNg }: Props) {
