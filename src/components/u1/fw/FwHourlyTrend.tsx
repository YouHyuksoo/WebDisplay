/**
 * @file src/components/u1/fw/FwHourlyTrend.tsx
 * @description FW 시간대별 검사 추이 — 그라데이션 면적 + 합격률 라인 + 요약
 *
 * 초보자 가이드:
...
import type { FwHourlyPoint } from "@/types/u1/fw-analysis";
...
export default function FwHourlyTrend({ hourlyTrend }: Props) {
      ...
      <div className="flex-1">
        <ResponsiveContainer width="100%" height="100%">
          <ComposedChart data={fullData} margin={{ top: 10, right: 10, left: -10, bottom: 5 }}>
            ...
            <Area yAxisId="left" type="monotone" dataKey="total" fill="url(#fwAreaGrad)"
