/**
 * @file src/components/u1/hipot/HipotMachineNg.tsx
 * @description HIPOT 머신별 NG 분포 — 수평 바 + 값 레이블 + NG율 + 요약
 *
 * 초보자 가이드:
...
import type { HipotMachineNgItem } from "@/types/u1/hipot-analysis";

interface Props {
  machineNg: HipotMachineNgItem[];
}

export default function HipotMachineNg({ machineNg }: Props) {
