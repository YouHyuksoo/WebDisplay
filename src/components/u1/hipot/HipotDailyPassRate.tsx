/**
 * @file src/components/u1/hipot/HipotDailyPassRate.tsx
 * @description HIPOT 당일 라인별 합격률 — 큰 도넛 + 요약 통계 패널
 *
 * 초보자 가이드:
...
export default function HipotDailyPassRate({ lineStats }: Props) {
