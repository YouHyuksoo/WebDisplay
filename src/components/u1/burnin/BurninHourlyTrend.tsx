/**
 * @file src/components/u1/burnin/BurninHourlyTrend.tsx
 * @description BURNIN 시간대별 검사 추이 — 그라데이션 면적 + 합격률 라인 + 요약
 *
 * 초보자 가이드:
...
import type { BurninHourlyPoint } from "@/types/u1/burnin-analysis";
...
export default function BurninHourlyTrend({ hourlyTrend }: Props) {
      ...
      <div className="flex-1">
        <ResponsiveContainer width="100%" height="100%">
          <ComposedChart data={fullData} margin={{ top: 10, right: 10, left: -10, bottom: 5 }}>
            <defs>
              <linearGradient id="burninAreaGrad" x1="0" y1="0" x2="0" y2="1">
            ...
            <Area yAxisId="left" type="monotone" dataKey="total" fill="url(#burninAreaGrad)"
