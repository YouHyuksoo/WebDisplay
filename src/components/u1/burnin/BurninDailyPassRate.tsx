/**
 * @file src/components/u1/burnin/BurninDailyPassRate.tsx
 * @description BURNIN 당일 라인별 합격률 — 큰 도넛 + 요약 통계 패널
 *
 * 초보자 가이드:
...
export default function BurninDailyPassRate({ lineStats }: Props) {
