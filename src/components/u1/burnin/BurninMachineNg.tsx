/**
 * @file src/components/u1/burnin/BurninMachineNg.tsx
 * @description BURNIN 머신별 NG 분포 — 수평 바 + 값 레이블 + NG율 + 요약
 *
 * 초보자 가이드:
...
import type { BurninMachineNgItem } from "@/types/u1/burnin-analysis";

interface Props {
  machineNg: BurninMachineNgItem[];
}

export default function BurninMachineNg({ machineNg }: Props) {
